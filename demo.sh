...
emit_block() {
	...
	# aged.json is 40 minutes old, well inside the 1-hour cutoff. It renders
	# identically to a fresh reading, which is the point: the age is not shown, so
	# this line is what a stale-but-accepted bucket looks like.
