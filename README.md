...
| `STATUSLINE_MODEL_USAGE_MAX_AGE` | 21600 | Seconds of age on Claude Code's cached usage fetch past which the per-model field hides itself instead of showing a stale number. |
